...
class Users(models.Model):
    UserName = models.CharField(max_length=50, db_index=True, null=False, unique=True)
    GivenName = models.CharField(max_length=50, db_index=False, null=False)
    MiddleName = models.CharField(max_length=30, db_index=False, blank=True, null=True)
    ...
    State = models.CharField(max_length=50, db_index=True, blank=True, null=False)
    EMail = models.EmailField(max_length=70, db_index=False, null=False)
    Phone = models.CharField(max_length=30, null=False, blank=False, unique=False)
    CellPhone = models.CharField(max_length=30, null=False, blank=True, unique=True)
    MessengerType = models.CharField(max_length=10, choices=MESSENGER_CHOICES, null=True, default="Telegram")
    MessengerID = models.CharField(max_length=30, blank=False, unique=False)
